...
# -------------------------------------------------------------------
# 0) Chemins (à adapter si tu changes l'arborescence)
# -------------------------------------------------------------------
data_file <- "data/FinalDataset.xlsx"

# -------------------------------------------------------------------
# 1) Import
# Hypothèse de structure : ton fichier contient un format "long" type :
# Pays | Nomdesvariables | 1990 | 1991 | ... | 2023
# (c'est cohérent avec l'annexe : pivot_longer puis pivot_wider) :contentReference[oaicite:1]{index=1}
# -------------------------------------------------------------------
...
# Objectif : obtenir des noms stables utilisés dans tes modèles
# dettepublique, croissancepib, inflation, depensespubliques, etc.
# Comme l'annexe est tronquée, on fait un mapping "souple" basé sur regex.
# -------------------------------------------------------------------
...
# Mapping possible (à ajuster si besoin après un coup d'oeil à names(FinalPanel))
# On renomme seulement si la cible n'existe pas déjà
